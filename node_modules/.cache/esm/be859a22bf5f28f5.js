let winston,url,MongoClient,logger,settings;_bf5‍.w("winston",[["default",["winston"],function(v){winston=v}]]);_bf5‍.w("url",[["default",["url"],function(v){url=v}]]);_bf5‍.w("mongodb",[["MongoClient",["MongoClient"],function(v){MongoClient=v}]]);_bf5‍.w("./lib/logger",[["default",["logger"],function(v){logger=v}]]);_bf5‍.w("./lib/settings",[["default",["settings"],function(v){settings=v}]]);

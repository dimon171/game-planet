...
const CategoryHero = ({ categoryDetails, categories }) => React.createElement(
	'section',
	{ className: 'main__header category-header section-container' },
	...
	React.createElement(
		'h1',
		{ className: 'main__title category-header__title' },
...
const CategoryContainer = props => {
	...
	return React.createElement(
		...
		React.createElement(
			...
			React.createElement(
				'div',
				{ className: 'category__aside' },
				showFilter === true && React.createElement(ProductFilter, props),
				React.createElement(BannerAside, null)
			),
			React.createElement(
				'div',

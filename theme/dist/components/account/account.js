...
const ReadOnlyField = ({ name, value }) => React.createElement(
	'div',
	{ className: 'checkout__field-preview field-preview' },
	React.createElement(
		'div',
		{ className: 'checkout__name field-preview__name' },
		name
	),
	React.createElement(
		'div',
		{ className: 'checkout__value' },
		value
	)
);
...
class Account extends React.Component {
	...
	render() {
		...
		if (customerProperties !== undefined) {
				...
				listHeader = orderHistory[i].map((p, j) => {
					if (j < 1) {
						return React.createElement(
							...
							Object.keys(p).map((k, l) => React.createElement(
								'th',
			...
			keyCounter = 0;
			for (var i in orderHistory) {
				list.push(orderHistory[i].map(p => React.createElement(
					'tr',
			...
			return React.createElement(
				'div',
				{ className: 'account-container section-container' },
				React.createElement(
					'div',
					{ className: 'account-section' },
					React.createElement(PageBreadcrumbs, { page: '\u041B\u0438\u0447\u043D\u044B\u0439 \u043A\u0430\u0431\u0438\u043D\u0435\u0442', path: '/account' }),
					React.createElement(
						'h2',
				...
				this.state.profileSection === 1 && !this.state.profileEdit && React.createElement(
					...
					React.createElement(
						...
						Object.keys(billingAddress).length > 0 && React.createElement(ReadOnlyField, { name: text.city, value: billingAddress.city }),
						Object.keys(billingAddress).length > 0 && React.createElement(ReadOnlyField, {
				...
				React.createElement(
					...
					React.createElement(
						'button',
						{ type: 'button', className: continueShoppingButton },
						React.createElement(
							Link,
							{
								to: '/',

		...
		if (!show) {
			...
			if (shippingMethod && shippingMethod.fields && shippingMethod.fields.length > 0) {
				shippingFields = shippingMethod.fields.map((field, index) => {
					...
					return React.createElement(
						'div',
						{ key: index, className: 'checkout__field-preview field-preview' },
						React.createElement(
							'div',
			...
			return React.createElement(
				...
				React.createElement(
					...
					!hideBillingAddress && React.createElement(
						'div',
						{ className: 'step__variants step__variants_shipping' },
						React.createElement(
							'h3',
						...
						React.createElement(
							'div',
							{ className: 'variants billing-as-shipping' },
							React.createElement(
								'label',
								{
									className: `input__checkbox ${this.state.billingAsShipping ? 'input__checkbox_checked' : ''}`,

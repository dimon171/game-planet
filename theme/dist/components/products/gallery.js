...
export default class GalleryProducts extends React.Component {
	constructor(...args) {
		...
		return _temp = super(...args), this.state = {
			...
			const filter = {
				...
				price_to,
				sort,
				fields: 'path,id,name,category_id,category_name,sku,images,enabled,discontinued,stock_status,stock_quantity,price,on_sale,regular_price,attributes,tags,variants',
				limit: limit || 4,
				offset: 0
			};
	...
	render() {
		...
		return React.createElement(ProductGallery, {
			products: products,
